...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(0, count_questions):
            ...
            question = str(i+1) + ") Верно ли, что " + president[0] + " является главой государства " + country_name[0] + "?"
            print(question)
            ...
            if((user_answer == right_answer) & (user_conf == 50)):
                ...
                print(str(count_conf_interval))
            else:
                if(user_answer == right_answer):
                    count_correct_answer+= 1
                    print(str(count_correct_answer))
        ...
        print("Ваша уверенность: " + str(total_confidence) + "%")
